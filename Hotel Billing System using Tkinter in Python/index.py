...
def bill_button_operation():
    ...
    if ans == "yes":
        bill = Toplevel()
        bill.title("MASA HotelSuite Manager")
...
root.title("MASA HotelSuite Manager")
...
title_label = Label(
    title_frame,
    text="Hotel & Cafe Billing System",
...
customer_frame = LabelFrame(
    root, text="Customer Details", font=("times new roman", 15, "bold"), bd=8, bg="green", relief=GROOVE
)
customer_frame.pack(side=TOP, fill="x")

customer_name_label = Label(customer_frame, text="Name", font=("arial", 15, "bold"), bg="green", fg="white")
...
customer_contact_label = Label(
    customer_frame, text="Contact", font=("arial", 15, "bold"), bg="green", fg="white"
)
...
menu_label = Label(
    menu_frame, text="Menu", font=("times new roman", 20, "bold"), bg="green", fg="White", pady=0
)
...
combo_lable = Label(
    menu_category_frame, text="Select Type", font=("arial", 12, "bold"), bg="green", fg="white"
)
...
item_title_label = Label(
    item_frame, text="Item", font=("times new roman", 20, "bold"), bg="green", fg="white"
)
...
item_name_label = Label(item_frame2, text="Name", font=("arial", 12, "bold"), bg="green", fg="white")
...
item_rate_label = Label(item_frame2, text="Price", font=("arial", 12, "bold"), bg="green", fg="white")
...
item_quantity_label = Label(item_frame2, text="Quantity", font=("arial", 12, "bold"), bg="green", fg="white")
...
order_title_label = Label(
    order_frame, text="Your Order", font=("times new roman", 20, "bold"), bg="green", fg="white"
)
...
total_price_label = Label(order_frame, text="Total Price", font=("arial", 12, "bold"), bg="green", fg="blue")
